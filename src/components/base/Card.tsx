  ...
  return (
    <Link href="/projects/mk-ultra">
      <div className="w-full h-full relative">
        <div
          className={cn(
            "w-full h-full flex flex-col bg-light-background-100 rounded-t-xl rounded-b-md cursor-pointer shadow relative group hover:ring hover:ring-light-primary-200  duration-100",
            {
              "hover:absolute hover:z-40 hover:h-fit hover:box-content hover:-top-4 hover:-left-4 hover:p-4": variant !== "big"
            },
            {
          ...
          <div className={"h-fit flex flex-row items-center gap-1 p-4 md:p-5"}>
            <div className="flex m-auto w-3/12">
              <Image
                ...
                height={0}
                sizes={"100vw"}
                className={`w-full h-auto aspect-square rounded-full object-cover p-2 ${variant === 'big' ? 'h-full' : ''}`}
                src={
                  "https://images.unsplash.com/photo-1680868543815-b8666dba60f7?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=2532&q=80"
                }
                alt={"User Profile"}
