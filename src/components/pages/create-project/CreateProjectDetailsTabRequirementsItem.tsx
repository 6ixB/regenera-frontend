...
export default function CreateProjectDetailsTabRequirementsItem({item, idx, handleRemoveRequirements}: CreateProjectDetailsTabRequirementsItemProps) {
    ...
    return (
        <tr>
            ...
            <td className="px-6 py-4 whitespace-nowrap text-end text-sm font-medium">
                ...
                onClick={() => handleRemoveRequirements(idx)}>Delete</button>
            </td>
        </tr>
    )
}