    ...
    return (
        <div className="w-full md:w-6/12 h-fit flex flex-col border rounded-lg shadow bg-light-background-100 ">
            ...
            <div className="w-full flex flex-col px-4 py-6 gap-y-2">
                ...
                <p className="text-base text-end">Volunteer to support <b>{projectData.title}</b></p>
                {projectData.donations?.length > 0
                    ?
                    <p className="text-md text-light-text-200 font-medium text-end">Join {projectData.donations?.length} other on this project!</p>
                    :
                    <p className="text-md text-light-text-200 font-medium text-end">Be the first volunteer for this project!</p>
                }
            </div>
